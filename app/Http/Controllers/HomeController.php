...
class HomeController extends Controller
{
    public  function index()
    {
        ...
        return view('welcome', compact('trenutnoVreme','sat')); // ako zelimo  da varijablu trenutno vreme prosledimo bladeu odnosno iz kontrolera prosledimo bladeu kucamo comapct pa ime varijable u view
    }
}
